                    ...
                    <div class="auth-inner row m-0">
                        ...
                        <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                ...
                                <form class="auth-register-form mt-2" id="register">
                                    @csrf
                                    <div class="mb-1">
                                    ...
                                    <button class="btn btn-primary w-100" tabindex="5" onclick="addFormData(event,'post','{{url('register')}}','{{url('/')}}','register')">Sign up</button>
                                </form>
