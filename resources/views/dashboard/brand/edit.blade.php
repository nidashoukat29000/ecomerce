                                   ...
                                   {{--    <div class="col-md-6 col-12">
                                      ...
                                      <div class="col-md-6 col-12">
                                        <div class="mb-1">
                                            ...
                                            <select class="form-select" id="status" name="status" value={{$brand->status}}>
                                      ...
                                      <div class="col-12">
                                          <button type="reset" class="btn btn-primary me-1" onclick="addFormData(event,'post','{{$url.'/'.$brand->id}}','{{$url}}','edit-brand')">Submit</button>
