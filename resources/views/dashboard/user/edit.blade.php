              ...
              <div class="row">
                  <div class="col-12">
                      <div class="card">
                          ...
                          <div class="card-body">
                              <form class="form" id="edit-user" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                  <div class="row">
                               ...
                               {{--      <div class="col-md-6 col-12">
                                      ...
                                      <div class="col-12">
                                          <button type="reset" class="btn btn-primary me-1" onclick="addFormData(event,'post','{{$url.'/'.$user->id}}','{{$url}}','edit-user')">Submit</button>
