              ...
              <div class="row">
                  <div class="col-12">
                      <div class="card">
                          ...
                          <div class="card-body">
                              <form class="form" id="add-banner" enctype="multipart/form-data">
                                @csrf
                                  <div class="row">
                               ...
                               {{--      <div class="col-md-6 col-12">
                                   ...
                                   {{--    <div class="col-md-6 col-12">
                                      ...
                                      <div class="col-12">
                                          <button type="reset" class="btn btn-primary me-1" onclick="addFormData(event,'post','{{$url}}','{{$url}}','add-banner')">Submit</button>
