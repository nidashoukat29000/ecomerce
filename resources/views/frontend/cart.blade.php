														...
														<tbody>
															...
															<tr>
																<td class="product-thumbnail  text-left">
																	...
																	<div class="single-product">
																		<div class="product-img">
																			<a href="single-product.html"><img src="{{asset('assets/img/product/12.jpg')}}" alt="" /></a>
																		</div>
																		<div class="product-info">
																			<h4 class="post-title"><a class="text-light-black" href="#">dummy product name</a></h4>
																			<p class="mb-0">Color :  Black</p>
															...
															<tr>
																<td class="product-thumbnail  text-left">
																	...
																	<div class="single-product">
																		<div class="product-img">
																			<a href="single-product.html"><img src="{{asset('assets/img/product/6.jpg')}}" alt="" /></a>
																		</div>
																		<div class="product-info">
																			<h4 class="post-title"><a class="text-light-black" href="#">dummy product name</a></h4>
																			<p class="mb-0">Color :  Black</p>
														...
														<div class="payment-method mt-60  pl-20">
															...
															<div class="payment-accordion">
																...
																<div class="payment-content">
																	...
																	<a href="#"><img src="{{asset('assets/img/payment/1.png')}}" alt="" /></a>
																	<a href="#"><img src="{{asset('assets/img/payment/2.png')}}" alt="" /></a>
																	<a href="#"><img src="{{asset('assets/img/payment/3.png')}}" alt="" /></a>
																	<a href="#"><img src="{{asset('assets/img/payment/4.png')}}" alt="" /></a>
																</div>
																<!-- Accordion end --> 
