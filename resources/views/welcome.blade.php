            ...
            <div class="row">
                <div class="col-md-5">
                    ...
                    <div class="single-banner banner-1 banner-4">
                        <a class="banner-thumb" href="#"><img src="{{ asset('assets/img/banner/3.jpg') }}" /></a>
                ...
                <div class="col-md-7">
                    ...
                    <div class="single-banner banner-3">
                        <a class="banner-thumb" href="#"><img src="{{ asset('assets/img/banner/4.jpg') }}"
                                alt="" /></a>
                        <div class="banner-brief">
                        ...
                        <div class="col-12">
                            <div class="single-product">
                                <div class="product-img">
                                    ...
                                    <a href="single-product.html"><img src="{{ asset('assets/img/product/1.jpg') }}"
                                            alt="" /></a>
                                </div>
                        ...
                        <div class="col-12">
                            <div class="single-product">
                                <div class="product-img">
                                    ...
                                    <span class="pro-price-2">$ 56.20</span>
                                    <a href="single-product.html"><img src="{{ asset('assets/img/product/5.jpg') }}"
                                            alt="" /></a>
                                </div>
                                <div class="product-info clearfix text-center">
                                    <div class="fix">
                        ...
                        <div class="col-12">
                            <div class="single-product">
                                <div class="product-img">
                                    <span class="pro-label new-label">new</span>
                                    <span class="pro-price-2">$ 56.20</span>
                                    <a href="single-product.html"><img src="{{ asset('assets/img/product/12.jpg') }}"
                                            alt="" /></a>
                                </div>
                                <div class="product-info clearfix text-center">
                                    <div class="fix">
                        ...
                        <div class="col-12">
                            <div class="single-product">
                                <div class="product-img">
                                    <span class="pro-label new-label">new</span>
                                    <span class="pro-price-2">$ 56.20</span>
                                    <a href="single-product.html"><img src="{{ asset('assets/img/product/6.jpg') }}"
                                            alt="" /></a>
                                </div>
                                <div class="product-info clearfix text-center">
                                    <div class="fix">
                            ...
                            <div class="single-product">
                                <div class="product-img">
                                    ...
                                    <a href="single-product.html"><img
                                            src="{{ asset('assets/img/product/8.jpg') }}" /></a>
                                </div>
                                <div class="product-info clearfix text-center">
                                    <div class="fix">
                                        <h4 class="post-title"><a href="#">dummy Product name</a></h4>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-5 col-md-5 col-sm-6">
                                            <a href="single-blog.html">
                                                <img src="{{ asset('assets/img/discount/5.jpg') }}" alt="" />
                                            </a>
                                        </div>
                                        <div class="col-lg-7 col-md-7 col-sm-6">
                                            <div class="discount-info">
                                                ...
                                                <a class="button-2 text-dark-red text-uppercase" href="#">GET
                            ...
                            <div class="col-lg-12">
                                <div class="discount-product">
                                    <div class="row">
                                        <div class="col-lg-5 col-md-5 col-sm-6">
                                            <a href="single-blog.html">
                                                <img src="{{ asset('assets/img/discount/6.jpg') }}" alt="" />
                                            </a>
                                        </div>
                                        <div class="col-lg-7 col-md-7 col-sm-6">
                                            <div class="discount-info">
                            ...
                            <div class="col-lg-12">
                                <div class="discount-product">
                                    <div class="row">
                                        <div class="col-lg-5 col-md-5 col-sm-6">
                                            <a href="single-blog.html">
                                                <img src="{{ asset('assets/img/discount/7.jpg') }}" alt="" />
                                            </a>
                                        </div>
                                        <div class="col-lg-7 col-md-7 col-sm-6">
                                            <div class="discount-info">
                            ...
                            <div class="col-lg-12">
                                <div class="discount-product">
                                    <div class="row">
                                        <div class="col-lg-5 col-md-5 col-sm-6">
                                            <a href="single-blog.html">
                                                <img src="{{ asset('assets/img/discount/8.jpg') }}" alt="" />
                                            </a>
                                        </div>
                                        <div class="col-lg-7 col-md-7 col-sm-6">
                                            <div class="discount-info">
                ...
                <div class="col-lg-4 col-md-4">
                    <div class="up-comming-product">
                        <div class="up-comming-img">
                            <a href="#"><img src="{{ asset('assets/img/product/up-comming.jpg') }}"
                                    alt="" /></a>
                        </div>
                                ...
                                <div class="col-xl-3 col-lg-4 col-md-6">
                                    <div class="single-product">
                                        <div class="product-img">
                                            ...
                                            <span class="pro-price-2">$ 56.20</span>
                                            <a href="single-product.html"><img
                                                    src="{{ asset('assets/img/product/11.jpg') }}"
                                                    alt="" /></a>
                                        </div>
                                        <div class="product-info clearfix text-center">
                                            <div class="fix">
                                ...
                                <div class="col-xl-3 col-lg-4 col-md-6">
                                    <div class="single-product">
                                        <div class="product-img">
                                            ...
                                            <span class="pro-price-2">$ 56.20</span>
                                            <a href="single-product.html"><img
                                                    src="{{ asset('assets/img/product/10.jpg') }}"
                                                    alt="" /></a>
                                        </div>
                                        <div class="product-info clearfix text-center">
                                            <div class="fix">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-blog mt-30">
                        <div class="blog-photo">
                            <a href="#"><img src="{{ asset('assets/img/blog/4.jpg') }}" alt="" /></a>
                            <div class="like-share text-center fix">
                                <a href="#"><i class="zmdi zmdi-favorite"></i><span>89 Like</span></a>
                                <a href="#"><i class="zmdi zmdi-comments"></i><span>59 Comments</span></a>
                                <a href="#"><i class="zmdi zmdi-share"></i><span>29 Share</span></a>
